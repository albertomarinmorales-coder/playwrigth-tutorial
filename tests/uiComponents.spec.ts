...
test('input fields', async ({page})=>{
    ...
    expect(inputValue).toEqual('test@test.com') // ASSERTION 
...
test('checkboxes', async ({page})=>{
    ...
    await page.getByRole('checkbox', {name: 'Hide on click'}).check({force:true}) // check sirve para checkear
    await page.getByRole('checkbox', {name: 'Hide on click'}).click({force:true}) // click realiza la accion de click
